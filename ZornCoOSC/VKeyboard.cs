...
namespace ZornCoOSC
{
    internal class VKeyboard
    {
        ...
        public static void SendWithShiftAndCtrl(ScanCodeShort a)
        {
            Send(ScanCodeShort.LCONTROL);
            Send(ScanCodeShort.LSHIFT);
            Send(a);
            ReleaseKey(a);
            ReleaseKey(ScanCodeShort.LCONTROL);
            ReleaseKey(ScanCodeShort.LSHIFT);
        }
        ...
        public static extern void keybd_event(VirtualKeyShort virtualKey, byte scanCode, uint flags, IntPtr extraInfo);
        public const int KEYEVENTF_EXTENDEDKEY = 0x0001; //Key down flag
        public const int KEYEVENTF_KEYUP = 0x0002; //Key up flag

        public static void SendMediaKey(VirtualKeyShort key)
        {
